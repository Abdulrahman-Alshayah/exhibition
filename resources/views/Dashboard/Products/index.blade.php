                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('products.edit',$product->id)}}"><i style="color: #0ba360" class="text-success ti-user"></i>&nbsp;&nbsp;تعديل البيانات</a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete{{$product->id}}"><i   class="text-warning ti-back-right"></i>&nbsp;&nbsp;حذف</a>
                                            </div>
                                        </div>
